import { i as d, r as u, K as p, a as m, x as f } from "./reown-appkit-connector-RlB2KFu3.mjs";
import { n as h, c as g } from "./if-defined-SxgRDNx5.mjs";
const v = d`
  :host {
    display: block;
...
var l = function(o, t, r, s) {
  var n = arguments.length, e = n < 3 ? t : s === null ? s = Object.getOwnPropertyDescriptor(t, r) : s, c;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") e = Reflect.decorate(o, t, r, s);
  else for (var a = o.length - 1; a >= 0; a--) (c = o[a]) && (e = (n < 3 ? c(e) : n > 3 ? c(t, r, e) : c(t, r)) || e);
