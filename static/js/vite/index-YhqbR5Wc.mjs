import { i as g, r as b, h as p, a as h, x as d } from "./reown-appkit-connector-RlB2KFu3.mjs";
import { n as e, c as w } from "./if-defined-SxgRDNx5.mjs";
...
`;
var r = function(s, o, t, n) {
  var c = arguments.length, i = c < 3 ? o : n === null ? n = Object.getOwnPropertyDescriptor(o, t) : n, l;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(s, o, t, n);
  else for (var u = s.length - 1; u >= 0; u--) (l = s[u]) && (i = (c < 3 ? l(i) : c > 3 ? l(o, t, i) : l(o, t)) || i);
...
let a = class extends h {
  ...
  render() {
    ...
    `;
    const o = (t = this.textVariant) != null ? t : x[this.size];
    return d`
      <button
  ...
  loadingTemplate() {
    if (this.loading) {
      const o = y[this.size], t = this.disabled ? v.disabled : v[this.variant];
      return d`<wui-loading-spinner color=${t} size=${o}></wui-loading-spinner>`;
    }
    return d``;
  }
};
