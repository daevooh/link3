import { i as h, r as p, h as w, a as x, x as m } from "./reown-appkit-connector-RlB2KFu3.mjs";
import { n as t, c as g, U as f } from "./if-defined-SxgRDNx5.mjs";
...
let d = class extends x {
  ...
  visualTemplate() {
    var o;
    if (this.imageSrc)
      return this.dataset.variant = "image", m`<wui-image src=${this.imageSrc} alt=${(o = this.alt) != null ? o : "avatar"}></wui-image>`;
    if (this.address) {
      this.dataset.variant = "generated";
      const r = f.generateAvatarColors(this.address);
      return this.style.cssText += `
 ${r}`, null;
    }
