import { V as de, X as x, i as he, r as ge, a as me, x as j } from "./reown-appkit-connector-RlB2KFu3.mjs";
import { n as z, c as we } from "./if-defined-SxgRDNx5.mjs";
...
function Nt() {
  return vt || (vt = 1, function(o) {
    ...
    o.isValid = function(n) {
      return n && typeof n.bit != "undefined" && n.bit >= 0 && n.bit < 4;
    }, o.from = function(n, t) {
      if (o.isValid(n))
        return n;
      try {
    ...
    var r = {
      single_source_shortest_paths: function(i, n, t) {
        ...
        for (var u, c, m, A, C, h, S, w, I; !a.empty(); ) {
          ...
          for (m in C)
            C.hasOwnProperty(m) && (h = C[m], S = A + h, w = s[m], I = typeof s[m] == "undefined", (I || w > S) && (s[m] = S, a.push(m, S), e[m] = c));
        }
        if (typeof t != "undefined" && typeof s[t] == "undefined") {
...
`
  ...
  return et.create = function(N, R) {
    ...
    let p = r.M, M, E;
    return typeof R != "undefined" && (p = r.from(R.errorCorrectionLevel, r.M), M = c.from(R.version), E = s.from(R.maskPattern), R.toSJISFunc && o.setToSJISFunction(R.toSJISFunc)), P(N, M, p, E);
  }, et;
}
var Bt = {}, Rt = {}, te;
function ae() {
  return te || (te = 1, function(o) {
    ...
    o.getOptions = function(n) {
      n || (n = {}), n.color || (n.color = {});
      const t = typeof n.margin == "undefined" || n.margin === null || n.margin < 0 ? 4 : n.margin, e = n.width && n.width >= 21 ? n.width : void 0, s = n.scale || 4;
      return {
        width: e,
        scale: e ? 4 : s,
        margin: t,
...
function Ue() {
  return ee || (ee = 1, function(o) {
    ...
    o.render = function(e, s, a) {
      let u = a, c = s;
      typeof u == "undefined" && (!s || !s.getContext) && (u = s, s = void 0), s || (c = n()), u = r.getOptions(u);
...
function Fe() {
  ...
  function i(t, e, s) {
    let a = t + e;
    return typeof s != "undefined" && (a += " " + s), a;
  }
  function n(t, e, s) {
    let a = "", u = 0, c = !1, m = 0;
    for (let A = 0; A < t.length; A++) {
...
function ke() {
  ...
  function t(e, s, a, u, c) {
    ...
    if (C) {
      ...
      A === 2 ? (c = a, a = s, s = u = void 0) : A === 3 && (s.getContext && typeof c == "undefined" ? (c = u, u = void 0) : (c = u, u = a, a = s, s = void 0));
    } else {
      if (A < 1)
        throw new Error("Too few arguments provided");
...
let v = class extends me {
  ...
  render() {
    ...
    return this.dataset.theme = this.theme, this.dataset.clear = String(this.arenaClear), this.style.cssText = `
     ...
     --local-icon-color: ${(r = this.color) != null ? r : Je}
  ...
  templateVisual() {
    var r;
    return this.imageSrc ? j`<wui-image src=${this.imageSrc} alt=${(r = this.alt) != null ? r : "logo"}></wui-image>` : this.farcaster ? j`<wui-icon
        class="farcaster"
        size="inherit"
        color="inherit"
        name="farcaster"
