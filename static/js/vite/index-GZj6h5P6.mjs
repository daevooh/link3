import { i as N, a as k, x as a, r as L, e as v, G as p, d as O, R as Y, O as V, f as z, A as E, W } from "./reown-appkit-connector-RlB2KFu3.mjs";
import { n as l, c as _, o as j, r as b } from "./if-defined-SxgRDNx5.mjs";
import { T as A, D as F } from "./index-CQzlxvtf.mjs";
...
let g = class extends k {
  ...
  createPaginationObserver() {
    const t = v.state.activeChain, { projectId: e } = V.state;
    this.paginationObserver = new IntersectionObserver(([r]) => {
      var o;
      r != null && r.isIntersecting && !this.loading && (p.fetchTransactions(O.getPlainAddress(this.caipAddress)), z.sendEvent({
        type: "track",
        ...
        properties: {
          ...
          projectId: e,
          cursor: this.next,
          isSmartAccount: ((o = E.state.preferredAccountTypes) == null ? void 0 : o[t]) === W.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      }));
    }, {}), this.setPaginationObserver();
  }
  ...
  getTransactionListItemProps(t) {
    var h, u, y, $, I;
    const e = F.formatDate((h = t == null ? void 0 : t.metadata) == null ? void 0 : h.minedAt), r = A.getTransactionDescriptions(t), o = t == null ? void 0 : t.transfers, i = (u = t == null ? void 0 : t.transfers) == null ? void 0 : u[0], n = !!i && ((y = t == null ? void 0 : t.transfers) == null ? void 0 : y.every((C) => !!C.nft_info)), c = A.getTransactionImages(o);
    return {
      date: e,
